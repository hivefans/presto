...
public final class ElasticsearchQueryRunner
{
    ...
    public static synchronized DistributedQueryRunner createElaticsearchQueryRunner()
            throws Exception
    {
        ...
        if (!tpchLoaded) {
            ...
            for (TpchTable table : tables) {
                EmbeddedElasticsearch.flush("tpch", table.getTableName());
            }
            tpchLoaded = true;
        }
    ...
    public static void createKeyspace(Client client, String keyspaceName)
    {
        client.admin().indices().prepareCreate(keyspaceName).setSettings(Settings.builder()
