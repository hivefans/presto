        ...
        extends AbstractTestFunctions
{
    ...
    @Test
    public void testCastToVarcChar()
            throws Exception
    {
        assertFunction("cast(TINYINT'37' as char)", CHAR, "37");
        assertFunction("cast(TINYINT'17' as char)", CHAR, "17");
    }
    ...
    public void testCastFromChar()
            throws Exception
    {
        assertFunction("cast(cast('37' as char(2)) as tinyint)", TINYINT, (byte) 37);
        assertFunction("cast(cast('17' as char(2)) as tinyint)", TINYINT, (byte) 17);
        assertFunction("cast(cast('17 ' as char(3)) as tinyint)", TINYINT, (byte) 17);
    }
