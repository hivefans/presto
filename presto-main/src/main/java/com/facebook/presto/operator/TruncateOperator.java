        ...
        implements Operator
{
    ...
    public static class TruncateOperatorFactory
            implements OperatorFactory
    {
        ...
        public TruncateOperatorFactory(int operatorId, PlanNodeId planNodeId)
        {
        ...
        public Operator createOperator(DriverContext driverContext)
        {
            ...
            OperatorContext context = driverContext.addOperatorContext(operatorId, planNodeId, TruncateOperator.class.getSimpleName());
            return new TruncateOperator(context);
        }
        ...
        {
            return new TruncateOperatorFactory(operatorId, planNodeId);
        }
    }
    ...
    public TruncateOperator(OperatorContext operatorContext)
    {
    ...
    public void addInput(Page page)
    {
        ...
        for (Block rowIds : page.getBlocks()) {
