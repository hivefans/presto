...
public final class IntegerOperators
{
    ...
    @LiteralParameters("x")
    @SqlType("varchar(x)")
    public static Slice castToVarchar(@LiteralParameter("x") long size, @SqlType(StandardTypes.INTEGER) long value)
    {
        // todo optimize me
    ...
    @LiteralParameters("x")
    @SqlType("char(x)")
    public static Slice castToChar(@LiteralParameter("x") long size, @SqlType(StandardTypes.INTEGER) long value)
    {
