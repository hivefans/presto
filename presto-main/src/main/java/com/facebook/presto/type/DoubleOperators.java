...
public final class DoubleOperators
{
    ...
    @LiteralParameters("x")
    @SqlType("varchar(x)")
    public static Slice castToVarchar(@LiteralParameter("x") long size, @SqlType(StandardTypes.DOUBLE) double value)
    {
    ...
    @LiteralParameters("x")
    @SqlType("char(x)")
    public static Slice castToChar(@LiteralParameter("x") long size, @SqlType(StandardTypes.DOUBLE) double value)
    {
